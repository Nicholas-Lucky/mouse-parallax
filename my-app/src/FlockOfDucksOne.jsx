        ...
        <div className="App"
            onPointerMove={e => {
                ...
                if (screenClicked === "Yes") {
                    ...
                    const parallax_elements = document.querySelectorAll(".flock-of-ducks-1");
            ...
            <header className="App-header">
                <div class="flock-of-ducks-1" onMouseDown={function(){setClickStatus("Yes")}} onMouseUp={function(){setClickStatus("No")}}>
